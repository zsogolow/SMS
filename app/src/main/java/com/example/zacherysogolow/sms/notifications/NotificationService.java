...
public class NotificationService extends IntentService {
     ...
     * @param body
     */
    public static void startActionNewSMS(Context context, String from, String body) {
     ...
     * @param length
     */
    public static void startActionScheduleSMS(Context context, String from, String body, long length) {
        Intent intent = new Intent(context, NotificationService.class);
     ...
     * @param length
     */
    public static void startActionSnoozeSMS(Context context, String from, String body, long length) {
        Intent intent = new Intent(context, NotificationService.class);
     ...
     * @param body
     */
    public static void startActionScheduledSMSDue(Context context, String from, String body, int msgId) {
        Intent intent = new Intent(context, NotificationService.class);
     ...
     * @param body
     */
    private void handleActionNewSMS(String from, String body) {
        Log.d(TAG, "handleActionNewSMS()");

        Context context = getApplicationContext();

        MySMSMessage message = new MySMSMessage(-1, from, body, false);
     ...
     * @param timeLength
     */
    private void handleActionScheduleNewSMS(String from, String body, long timeLength) {
        ...
        int rowId = (int)dbHelper.insertSMS(from, body, true);
     ...
     * @param timeLength
     */
    private void handleActionSnoozeSMS(String from, String body, long timeLength, int msgId) {
     ...
     * @param body
     */
    private void handleActionScheduledSMSDue(String from, String body, int msgId) {
        Log.d(TAG, "handleActionScheduledSMSDue()");

        Context context = getApplicationContext();

        MySMSMessage message = new MySMSMessage(msgId, from, body, false);
